...
date: today
abstract: "This paper explores whether or not we can predict whether a song was produced by Jack Antonoff using the audio features provided by Spotify's API. We find that in general our logistic regression model has an accuracy score of 76%, a precision score of 39%, and a recall of 75.61%. Our random forest has an accuracy of 61%, and a No Information Rate of 43%. We interestingly found that danceability, a metric trained on human-tagged data, was a key predictor. Our results have implications for computational explorations of culture, how the combination human subjectivity and machine listening can come to create an approximate for style."
format: pdf
