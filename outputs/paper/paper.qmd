...
Sometime in early October of 2022 there was a chemical shift in my brain and I couldn't stop listening to Taylor Swift. I was a preteen when my best friend's sister showed us Our Song on the family desktop, went on to own a copy of Fearless, and was in the ninth grade when Red came out. My listening tapered off after that, other than ironically dancing to Blank Space in friends kitchens in college, and a road trip a few years ago where we belted Fearless (Three of the four people present were going through something).

All this to say, I can quite confidently say I hadn't listened to much or any Taylor Swift until October, when I couldn't listen to anything other than Fearless or Red when deadlifting, walking to a friend's house, folding laundry, etc. I listened to so much Taylor in that month alone that she ended up as my #4 artist on Spotify Wrapped, which stops collecting its data for the year on October 31st. It didn't even capture what happened to me after Midnights dropped in November.
...
Midnight was produced by Swift and her longtime collaborator Jack Antonoff, who is the subject of this essay, and, I suspect, the reason behind both my blacking out, and the stranger's "Exactly".

Antonoff is prolific, to the extent that it is starting to bother people. He has produced and co-produced music for Lorde, Taylor Swift, Florence and the Machine, The Chicks, Clairo, The 1975, Grimes, Zayn, Pink, Lana Del Rey, Olivia Rodrigo, Minions: The Rise of Gru Soundtrack, and more. All of this and his own bands too: Bleachers, and fun.

When I was getting brunch with a friend one Sunday and a Swift song came on, and she said "Jack Antonoff's gonna kill us all", we both laughed. What my friend was referring to, of course, is the fact that Jack Antonoff seems to be everywhere these days. As Andrew Marantz writes in the New Yorker: "When his band releases an album, the world responds politely. When he produces one by Lorde or Lana Del Rey or Taylor Swift, the world wobbles on its axis".

What I am trying to get to here is that I don't really mind Jack Antonoff's music. I kind of like it actually. But I still say his voice with the same tone that everyone else does. There's just something about him... this sense that he's everywhere... and that he's just such a nice guy... Why are we all so fixated on him? What is it about Antonoff music that is so Antonoff-y?

To find an answer to this question, I turned people, statistics, and the overlord of engineered virality itself -- the Spotify API.
...
2.  his relationship to music growing up (you can skim this, but there are some gems in there)
...
6.  Which was further doubled down on when I found a screenshot he took of his Tweet drafts in June 2021, one of them reading: "people often say to me:"caleb, what's wrong with jack antonoff?". don't ask questions"
...
Taste is subjective. People who can play instruments tend to be better at identifying and describing sounds. Cultural criticism is a hall of smoke and mirrors. Antonoff is everywhere.
...
This is pretty vague. I compared the valence scores of classical music tracks to see if this score is based on lyrics, or the audio itself. Jupiter's valence score is 326.78% higher than Mars. This not only indicates the valence is based on audio features other than lyrical content, but that it is capturing a difference between the two songs' profiles.
...
sub_planets |>
  select(artist_name, valence, track_name) |>
  head() |>
  knitr::kable(
...
I looked at the valence measures on Flight of the Bumblebee, a song that's much faster and "upbeat" than Mars and Jupiter. What I found complicated my understanding of valence -- different performance of the same song had different valence scores.
...
and danceability as "how suitable a track is for dancing based on a combination of musical elements including tempo, rhythm stability, beat strength, and overall regularity. A value of 0.0 is least danceable and 1.0 is most danceable". Neither of these definitions fully cover what metrics and thresholds go into something like "danceability". However, whatever these features capture is easier to compare across artists in visualizations than more granular details about bars, beats, duration, and tatums -- a word I just learned, which refers to "the lowest regular pulse train that a listener intuitively infers from the timing of perceived musical events". The full documentation for each variable included in this study is available in the Appendix.
